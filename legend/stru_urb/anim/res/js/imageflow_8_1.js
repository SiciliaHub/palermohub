...
{	
	...
	if (dragging == false)
	{
		...
		slider_div.style.marginLeft = (new_slider_pos - conf_slider_width)* 1.57 + 'px';
	}
}
...
function refresh(onload)
{
	...
	scrollbar_div.style.marginLeft = images_width * 0 + 'px';
	scrollbar_div.style.width = scrollbar_width * 1.68 + 'px';
