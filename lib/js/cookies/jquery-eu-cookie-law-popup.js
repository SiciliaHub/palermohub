...
$(document).ready( function() {
	if ($(".eupopup").length > 0) {
		$(document).euCookieLawPopup().init({
			...
			'popupTitle' : '<img src="legend/pa_hub.svg" alt="Palermo Hub" title="Palermo Hub" width="200" height="37" border="0" ><br><br> Questo sito, palermohub.opendatasicilia.it utilizza i cookie, anche di terze parti, per migliorare la vostra esperienza di navigazione web. <br> ',
