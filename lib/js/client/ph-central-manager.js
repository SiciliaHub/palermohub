...
class PalermoHubManager {
        ...
        this.modalCoordinator = {
            openHeader: () => {
                if (this.state.footerOpen) {
                    this.closeFooter('header opening');
                }
            ...
            openFooter: () => {
                if (this.state.headerOpen) {
                    this.closeHeader('footer opening');
                }
    ...
    setupEventCoordination() {
        ...
        this.setupModalCoordination(); // Setup dopo event coordinator
    }
        ...
        if (container) {
            container.innerHTML = `
                <div style="
                    ...
                    max-width: 600px;
                ">
                    <h3 style="color: #dc2626; margin-bottom: 1rem;">⚠️ Errore Caricamento Dati</h3>
