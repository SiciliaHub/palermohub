...
// footer.js - Footer semplificato con funzionalitÃ  di condivisione
document.addEventListener('DOMContentLoaded', function() {
    ...
    footer.innerHTML = `
        <div class="footer-content">
            <div class="footer-text">
                <strong>PalermoHub</strong> é una piattaforma dedicata alla visualizzazione e condivisione di mappe e dati geografici open data.<br>
    ...
    // Carica Font Awesome se non é giÃ  presente
...
function updateFooterSearchForPage(pageType) {
    ...
    if (pageType === 'index') {
        ...
        searchInput.placeholder = "Cerca mappe per titolo, descrizione, autore, territorio.. (la ricerca ti porterÃ  alla homepage)";
