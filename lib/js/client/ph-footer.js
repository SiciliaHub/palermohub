        ...
        <div class="footer-content">
            ...
            <div class="footer-social">
                <div class="social-buttons">
                    ...
                    <a href="https://github.com/SiciliaHub/palermohub" class="social-btn github" title="Repository GitHub - PalermoHub di opendatasicilia.it è come una grande biblioteca digitale piena di mappe interattive di Palermo e della Sicilia. Invece di libri sugli scaffali, qui trovi centinaia di mappe che mostrano tutto quello che può interessarti della città: dal traffico ai monumenti, dalla geologia alle piste ciclabili. Rende visibili e accessibili dati che spesso sono sepolti in documenti tecnici o siti istituzionali difficili da navigare, è un po' come tradurre il burocratese in linguaggio normale e presentarlo in modo visivamente comprensibile." target="_blank">
...
function shareCurrentSearchOn(platform) {
    ...
    switch (platform) {
        case 'facebook':
            // Usa l'API più semplice e affidabile di Facebook
            socialUrl = `https://www.facebook.com/share.php?u=${encodeURIComponent(shareUrl)}`;
            break;
        case 'twitter':
    ...
    if (platform === 'email') {
        ...
        // Per i social apri in una nuova finestra
...
// [Tutte le altre funzioni privacy e social rimangono identiche]
...
// Funzioni social sharing (mantenute identiche)
