            ...
            <div class="footer-search-wrapper">
                <div class="footer-search-input-container" id="footer-search-input-container">
                    ...
                    <input type="text" 
                           ...
                           placeholder="Cerca mappe di PalermoHub..."
                           autocomplete="off"
                           autocorrect="off"
                           spellcheck="false">
                ...
                <div id="footer-search-suggestions" class="footer-search-suggestions">
                    <div class="footer-suggestions-header">
                        <div class="footer-suggestions-title"><i class="fas fa-bullseye"></i> Risultati di ricerca</div>
                        <div class="footer-suggestions-count" id="footer-suggestions-count">0 risultati</div>
                    </div>
    ...
    if (!document.getElementById(cssId)) {
        ...
        style.innerHTML = `
            ...
            .footer-search-suggestions {
                ...
                right: 0;
                background: white;
                border: 2px solid var(--primary-color, #ff9900);
                border-radius: 12px;
            ...
            /* Dark Mode Support */
            [data-theme="dark"] .footer-search-container {
                background: linear-gradient(135deg, rgba(255, 167, 38, 0.15), rgba(100, 181, 246, 0.1));
                border-top-color: rgba(255, 167, 38, 0.3);
            }
            ...
            [data-theme="dark"] .footer-search-input-container.focused {
                border-color: var(--primary-color, #ffa726);
            ...
            [data-theme="dark"] .footer-suggestions-list::-webkit-scrollbar-track {
                background: var(--border-color, #3c4043);
            }
