...
class FooterSmartSearch {
    ...
    determineCsvPath() {
        ...
        // Se siamo in una sottocartella o in un file HTML, vai alla directory superiore
        if (isInSubfolder || currentPage.endsWith('.html')) {
            return '../dati-palermo-hub/palermo-hub.csv';
        }
...
function determineFinalMapUrl(mapUrl) {
    ...
    // Se siamo in una sottocartella o file HTML, torna alla directory superiore
