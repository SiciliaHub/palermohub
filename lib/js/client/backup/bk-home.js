...
// JAVASCRIPT COMPLETO CON CORREZIONI PAGINAZIONE E ORDINAMENTO PER DATA
...
document.addEventListener('DOMContentLoaded', function() {
    console.log('[INIT] Initializing PalermoHub with improved date sorting');
    ...
    console.log('[INIT] PalermoHub initialization completed with date sorting improvements');
});