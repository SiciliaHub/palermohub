    ...
    try {
        ...
        vectorLayers.forEach(layer => {
            if (layer.id === "Zone OMI") {
                // Colori da stile QGIS zto_omi.qml (campo ZTO → hex)
                const omiColorMatch = [
                    "match", ["get", "ZTO"],
                    // B – Residenziale
                    "B0a", "#ff7f7f",
                    ...
                    "B4A", "#260000",
                    "B4b", "#260000",
                    // Ca/Cb – Centro storico
                    "Ca",  "#ff9f7f",
                    "Cb",  "#ff9f7f",
                    // D – Produttivo/Commerciale
                    "D1",  "#bf7fff",
                    "D2",  "#00ffff",
                    // F – Attrezzature/Servizi
                    "F1",      "#7fffff",
                    "F11",     "#7fffff",
                    "F12",     "#7fffff",
                    "F13",     "#7fffff",
