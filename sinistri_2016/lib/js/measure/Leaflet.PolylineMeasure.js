(function() {
	...
	L.Control.PolylineMeasure = L.Control.extend({
		...
		options: {
			 ...
			 * @default
 			 */
			clearControlTitle: 'Cancella la misurazione',
			/**
		...
		_getTitle: function() {
			var self = this;
			return self.options.title ? self.options.title : 'Polilinea di misura ' + (self.options.imperial ? '[imperial]' : '[Sistema metrico]');
		},
